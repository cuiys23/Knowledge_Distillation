...
(IL-DDKD) described in Section~\ref{sec:proposed_framework}-\ref{section:3-1}. 
...
(FL-PFC) detailed in Section~\ref{sec:proposed_framework}-\ref{section:3-2}. 
...
and the complete execution process is detailed in Algorithm \ref{Alg:FL-PFC}. 
