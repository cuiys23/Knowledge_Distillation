...
\begin{algorithm}[t]
	...
	\begin{algorithmic}[1]
		...
		\STATE ${\pi _{proxy}},{\gamma ^{proxy}} \leftarrow \bar \pi ,\mathcal O\left( {\bar \gamma } \right)$
...
To address this issue, this paper incorporates a decay function $\mathcal{O}(\cdot)$ 
into the weight coefficient of the communication-constrained TT\&C center 
to mitigate the negative impact of the virtual client during model aggregation.